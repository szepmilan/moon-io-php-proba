    ...
    <head>
        ...
        <style>
            body {
                ...
                background-color: rgb(65, 165, 228)
            }
        </style>
    </head>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div style="text-align: center">
                ...
                @forelse ($users as $user)
                    <div>
                        {{$user->first_name}}
                        <a href="{{ route('user',$user)}}" style="background-color: red; color: white">
                ...
                <div style="border: solid black 2px; text-align: center;padding: 10px;background: rgb(65, 165, 228);
                color: white;
                ">
                    <h1>New Todo User</h1>
                    <form method="post" action="{{route('saveUser')}}" accept-charset="UTF-8">
                        {{ csrf_field() }}
